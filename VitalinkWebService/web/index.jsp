<!DOCTYPE html>
<!-- saved from url=(0064)http://www.cs.umd.edu/hcil/sharp/twinlist/dev/indev/-/index.html -->
<%
...
<head>
    ...
    <title>twinlist demo</title>
    <!-- <link rel="stylesheet" href="http://www.cs.umd.edu/hcil/sharp/twinlist/dev/indev/-/css/style.css"> -->
    ...
    <script src="./js/feedbackService.js"></script>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            window.controller.changeDataset(<%= data %>);
        });
        <% } %>
    </script>
</head>
...
<div class="center panel">
    <div id="app" class="content-text">
        ...
        <div class="help-modal modal scroll-y">
        ...
        <footer class="branding">
            <ul>
                <li><img src="./img/sharpc_logo.jpg" class="logo"></li>
                <li><img src="./img/hcil_logo.jpg" class="logo"></li>
                <li><img src="./img/umd_logo.gif" class="logo"></li>
            </ul>
        </footer>
    </div>
</div>
