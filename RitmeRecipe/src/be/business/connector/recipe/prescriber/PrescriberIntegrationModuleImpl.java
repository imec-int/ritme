...
public class PrescriberIntegrationModuleImpl extends AbstractIntegrationModule implements PrescriberIntegrationModule {
	...
	public String createPrescription(boolean feedbackRequested, long patientId, byte[] prescription, String prescriptionType, String nihiiOrg) throws IntegrationModuleException {
		...
		try {
            ...
            LOG.error("Recipe prescriptionValidation:" + (stopValidation - startValidation));

			// init helper
            long startCreateMarshaller = System.currentTimeMillis();
            ...
            long stopCreateMarshaller = System.currentTimeMillis();
            LOG.error("Recipe createMarshaller:" + (stopCreateMarshaller - startCreateMarshaller));
            ...
            long stopCompress = System.currentTimeMillis();
            LOG.error("Recipe compress:" + (stopCompress - startCompress));

			KeyResult key = getNewKey(pid, prescriptionType, nihiiOrg);
            long startSealUnknown = System.currentTimeMillis();
            message = sealPrescriptionForUnknown(key, message, nihiiOrg);
            long stopSealUnknown = System.currentTimeMillis();
            LOG.error("Recipe sealUnknown:" + (stopSealUnknown - startSealUnknown));
            ...
            long startEncodeSymmKey = System.currentTimeMillis();
            params.setSymmKey(getSymmKey(nihiiOrg).getEncoded());
            long stopEncodeSymmKey = System.currentTimeMillis();
            LOG.error("Recipe encodeSymmKey:" + (stopEncodeSymmKey - startEncodeSymmKey));
            ...
            long startSeal = System.currentTimeMillis();
            ...
            long stopSeal = System.currentTimeMillis();
            LOG.error("Recipe seal:" + (stopSeal - startSeal));
            ...
            long startBase64Decode = System.currentTimeMillis();
            info.setKeyIdentifier(Base64.decode(key.getKeyId()));
            long stopBase64Decode = System.currentTimeMillis();
            LOG.error("Recipe base64Decode:" + (stopBase64Decode - startBase64Decode));
            ...
            long stopUnseal = System.currentTimeMillis();
            LOG.error("Recipe unseal:" + (stopUnseal - startUnseal));
