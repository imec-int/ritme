...
import be.business.connector.recipe.executor.ExecutorIntegrationModuleV3Impl;
import be.recipe.client.services.executor.ListNotificationsItem;

public class ExecutorIntegrationModuleV3Mock extends ExecutorIntegrationModuleV3Impl {
	private static final Logger LOG = Logger.getLogger(ExecutorIntegrationModuleV3Mock.class);
	 ...
	 */
	public ExecutorIntegrationModuleV3Mock() throws IntegrationModuleException {
		super();
	...
	/** {@inheritDoc} */
	@Override
	public void createFeedback(long prescriberId, String rid,
							   byte[] feedbackText, final String nihiiOrg) throws IntegrationModuleException {
	}
	...
	/** {@inheritDoc} */
	@Override
	public be.business.connector.recipe.executor.domain.GetPrescriptionForExecutorResult getPrescription(String rid, final String nihiiOrg)
			throws IntegrationModuleException {
		LOG.info("GetPrescriptionForExecutorResult : " + rid);
		be.business.connector.recipe.executor.domain.GetPrescriptionForExecutorResult result = 
			new be.business.connector.recipe.executor.domain.GetPrescriptionForExecutorResult();
	...
	/** {@inheritDoc} */
	@Override
	public List<ListNotificationsItem> listNotifications(boolean readFlag, final String nihiiOrg)
			throws IntegrationModuleException {
	...
	/** {@inheritDoc} */
	@Override
	public void revokePrescription(String rid, String reason, final String nihiiOrg)
			throws IntegrationModuleException {
