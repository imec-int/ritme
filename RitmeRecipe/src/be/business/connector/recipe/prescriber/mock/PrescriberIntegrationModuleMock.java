...
public class PrescriberIntegrationModuleMock extends PrescriberIntegrationModuleImpl {
	...
	@Override
	public String createPrescription(boolean feedbackRequested, long patientId,
			byte[] prescription, String prescriptionType, String nihiiOrg)
	...
	/** {@inheritDoc} */
	@Override
	public GetPrescriptionForPrescriberResult getPrescription(String rid, final String nihiiOrg, final String patientSSIN)
	throws IntegrationModuleException {
	...
	/** {@inheritDoc} */
	@Override
	public List<ListFeedbackItem> listFeedback(boolean readFlag, final String nihiiOrg)
	throws IntegrationModuleException {
		...
		for( int i = 0 ; i < 10 ; i ++ ){
			...
			item.setSentDate(Calendar.getInstance());
			list.add(item);
		}
		return list;
	}
	...
	/** {@inheritDoc} */
	@Override
	public List<String> listOpenPrescription(String patientId, final String nihiiOrg, final Long prescriberId)
	throws IntegrationModuleException {
	...
	/** {@inheritDoc} */
	@Override
	public void prepareCreatePrescription(String patientId, String pp, final String nihiiOrg) {
		LOG.info("prepareCreatePrescription : " + patientId);
	}

	/** {@inheritDoc} */
	@Override
	public void revokePrescription(String rid, String reason, final String nihiiOrg, final String patientSSIN)
	throws IntegrationModuleException {
	...
	public void sendNotification(byte[] notificationText, String patientId,
								 long executorId, final String nihiiOrg) throws IntegrationModuleException {
		LOG.info("sendNotification");
	}

	/** {@inheritDoc} */
	@Override
	public void updateFeedbackFlag(String rid, boolean feedbackAllowed, final String nihiiOrg, final String patientSSIN)
	throws IntegrationModuleException {
