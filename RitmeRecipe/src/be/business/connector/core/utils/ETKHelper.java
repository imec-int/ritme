...
public class ETKHelper {
		...
		if (propertyHandler.hasProperty(MY_ETK_PROPERTY)) {
			...
			if (myETK.indexOf(';') > -1) {
				...
				try {
					...
					List<EncryptionToken> encryptionTokens = new ArrayList<EncryptionToken>();
	...
	public List<EncryptionToken> getEtks(KgssIdentifierType identifierType, Long identifierValue) throws IntegrationModuleException {
