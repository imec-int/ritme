...
import be.apb.standards.smoa.schema.v1.PharmaceuticalPrescriptionEventType;
...
public enum EventType {
	...
	PHARMACEUTICAL_PRESCRIPTION(PharmaceuticalPrescriptionEventType.class){
	...
	private Class<? extends AbstractEventType> type;
